...
<body>
	...
	<div class="flex flex-row items-center justify-center">
			<div class="basis-full flex justify-center text-3xl font-bold
				...
				text-blue-300 self-center "> Flights List </div>
		</div>
		<div class="flex flex-row items-center justify-center">
	...
	<form class="flex w-max mx-auto items-center justify-center bg-amber-400 my-7 rounded-lg" 
		...
		<div>
			...
			<input class="rounded-lg p-1 m-2" type="string" name="Airport" placeholder="Airport">
		</div>
		<div>
			<input class="rounded-lg p-1 m-2" type="number" name="Price" placeholder="Price">
		</div>
		<div class="p-4 ps-3">
